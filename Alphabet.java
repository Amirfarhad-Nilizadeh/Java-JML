public class Alphabet {
   ...
   public /*@ pure @*/ Alphabet(char c) 
   {
    ...
    /*@ private normal_behavior
      ...
      @   ensures vowel_set && vowel == (c == 'a' || c == 'A' || c == 'e' || c == 'E' 
      @    	                      || c == 'i' || c == 'I' || c == 'o'
      @				      || c == 'O' || c == 'u' || c == 'U'); 
      @ also
      @ private normal_behavior
      @	  requires vowel_set;
      @   assignable vowel_set;
      @   ensures vowel_set; @*/
   ...
   /*@ private normal_behavior
     @ {|
     @		requires !uppercase_set;
     @   	assignable uppercase_set, uppercase;
     @   	ensures uppercase_set;
     @   	ensures uppercase ==> ('A' <= c && c <= 'Z');
     @ also
     @		requires uppercase_set;
     @		assignable uppercase_set;
     @   	ensures uppercase_set;	
     @ |} @*/
   ...
   /*@ private normal_behavior
     @ {|
     @		requires !lowercase_set;
     @   	assignable lowercase_set, lowercase;
     @   	ensures lowercase_set;
     @   	ensures lowercase ==> ('a' <= c && c <= 'z'); 
     @ also
     @		requires lowercase_set;
     @   	assignable lowercase_set;
     @		ensures lowercase_set;
     @ |} @*/
